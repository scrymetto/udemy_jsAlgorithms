...
### Merge 
Делим массив на более мелкие до тех пор, пока в массиве не останется по 1 элементу. Массив из 1 элемента всегда отсортирован. Далее начинаем мёржить мелкие массивы в более крупные.